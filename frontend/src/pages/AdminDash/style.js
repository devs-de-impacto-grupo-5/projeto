...
export const InlineBadge = styled.span`
  ...
  padding: 6px 10px;
  border-radius: 12px;
  background: rgba(106, 58, 159, 0.12);
  color: ${accent};
  font-weight: 900;
  font-size: 12px;
`;
...
export const StepItem = styled.div`
  ...
  border-radius: 12px;
  border: 1px solid ${border};
  background: ${(props) => (props.$active ? 'rgba(106, 58, 159, 0.1)' : card)};
...
export const StepDot = styled.div`
  ...
  height: 10px;
  border-radius: 50%;
  background: ${(props) => (props.$active ? accent : borderStrong)};
`;
...
const tableCols = '0.8fr 2fr 1fr 1fr 1fr 1fr';
...
export const EditalTitle = styled.span`
  font-weight: 900;
  color: ${text};
  font-size: 14px;
  letter-spacing: -0.01em;
...
export const EditalMeta = styled.span`
  font-size: 12px;
  color: ${muted};
  font-weight: 700;
`;
...
export const EmptyAction = styled.button`
  ...
  &:hover {
    background: rgba(106, 58, 159, 0.06);
    transform: translateY(-1px);
    box-shadow: ${shadowSm};
  }
  ...
  &:focus-visible {
    outline: none;
    box-shadow: 0 0 0 3px rgba(107, 46, 158, 0.16);
  }
`;
